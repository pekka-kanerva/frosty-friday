...
-- Solution
select to_json(object_construct( 'country_of_residence', t.country_of_residence
                               , 'superhero_name', t.superhero_name 
                               , 'superpowers', array_construct_compact(t.superpower, t.second_superpower, t.third_superpower)))
from week_14 t;
