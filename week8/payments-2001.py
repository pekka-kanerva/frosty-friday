...
query = """select trunc(payment_date, 'WEEK') as payment_date
...
def app_creation():
    ...
    min_filter = st.slider('Select min date', min_date, max_date, min_date)
    max_filter = st.slider('Select max date', min_date, max_date, max_date)
